                      ...
                      <div className="p-4 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-3 border-t border-gray-100">
                          ...
                          <a
                            ...
                            className="flex items-center justify-center gap-2 w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2.5 rounded-lg text-sm font-semibold transition-all hover:shadow-md group/btn"
                          >
