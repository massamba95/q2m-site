...
function whatsappOrderLink(product: Product) {
  const message = `Bonjour Q2M, je souhaite commander :

📦 *${product.designation}*
🔖 Réf: ${product.ref_produit}
💰 Prix: ${formatFCFA(product.selling_price)} / ${product.unit}
                        ...
                        <div className="mt-auto pt-3 border-t border-gray-100">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <a
                              ...
                              className="flex items-center justify-center gap-1.5 bg-green-500 hover:bg-green-600 text-white px-3 py-2.5 rounded-lg text-xs sm:text-sm font-semibold transition-all hover:shadow-md group/btn"
                            >
