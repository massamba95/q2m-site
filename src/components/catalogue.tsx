const categories = [
  {
    ...
    desc: 'Ciment, fer a beton, sable, gravier, briques, parpaings et tout le necessaire pour vos fondations et structures.',
    icon: '🏗️',
    items: ['Ciment', 'Fer a beton', 'Briques', 'Parpaings', 'Sable', 'Gravier'],
  },
  {
    name: 'Plomberie',
    desc: 'Tuyaux, raccords, robinets, sanitaires et accessoires pour toutes vos installations de plomberie.',
    icon: '🔧',
    items: ['Tuyaux PVC', 'Raccords', 'Robinets', 'Sanitaires', 'Joints', 'Colles'],
  },
  {
    name: 'Electricite',
    desc: 'Cables, interrupteurs, prises, disjoncteurs et materiel electrique aux normes pour vos installations.',
    icon: '⚡',
    items: ['Cables', 'Interrupteurs', 'Prises', 'Disjoncteurs', 'Ampoules', 'Gaines'],
  },
  {
    name: 'Outillage',
    desc: 'Outils a main et electriques pour les professionnels et les bricoleurs. Marques reconnues.',
    icon: '🛠️',
    items: ['Marteaux', 'Tournevis', 'Perceuses', 'Scies', 'Niveaux', 'Metres'],
  },
  {
    name: 'Peinture & Finitions',
    desc: 'Peintures interieures et exterieures, pinceaux, rouleaux et tous les accessoires pour vos finitions.',
    icon: '🎨',
    items: ['Peinture murale', 'Peinture bois', 'Pinceaux', 'Rouleaux', 'Enduits', 'Diluants'],
  },
  {
    name: 'Quincaillerie generale',
    desc: 'Vis, boulons, clous, serrures, charnières et tous les petits accessoires indispensables.',
    icon: '🔩',
    items: ['Vis', 'Boulons', 'Clous', 'Serrures', 'Charnières', 'Cadenas'],
  },
]
